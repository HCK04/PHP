...
if(isset($_GET['id'])){
    $statment = $pdo->prepare('SELECT  voyage.codeVoyage,inscription.codeVoy,voyage.codDesc,descriptionvoyage.codDesc,dateVoy,villeD,villeA,heureDepart FROM inscription,voyage  WHERE inscription.codeVoyage = voyage.codeVoyage AND codeEmp = :codeEmp')
}
?>
