...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $statment = $pdo->prepare('SELECT codeVoyage FROM descriptionVoyage,voyage WHERE voyage.codDesc = descriptionVoyage.codDesc AND villeD = :villeD AND villeA = :villeA');
    $statment->execute([
        ':villeD' => $villeD,
        ':villeA' => $villeA
    ]);
